      ...
      <div className="w-full max-w-md">
        <Card className="backdrop-blur-sm bg-card/95 shadow-2xl border border-border/20">
          ...
          <div className="flex flex-col items-center p-8 pb-6">
            ...
            <p className="text-muted-foreground mt-2 text-sm">Track your expenses smartly</p>
          </div>
          ...
          <div className="px-8 pb-8 space-y-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white dark:bg-gray-800 border border-border rounded-lg hover:bg-muted dark:hover:bg-gray-700 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed font-medium text-foreground"
            >
              {isLoading ? (
